...
| Pokemon Red automated performance gate | Pass | `python -B scripts\verify_pokemon_red_performance.py --json-output qa-output\pokemon-red-performance-gate.json` | Latest run: text `run_fps=83.96`; sprites `run_fps=68.29`; sprites with headless audio output `run_fps=58.93`, `apu_dropped_samples=0`; deterministic frame/instruction/cycle totals matched exactly. |
...
- Current automated performance gate:
  - Text scene: 240 frames, `run_fps=83.96`, `cpu_instr=1564703`, `cpu_cycles=16853764`.
  - Sprite-heavy scene: 600 frames, `run_fps=68.29`, `cpu_instr=2717563`, `cpu_cycles=42134400`, `ppu_max_sprites=10`, `ppu_sprite_lines=19200`.
  - Sprite-heavy scene with headless audio output: 600 frames, `run_fps=58.93`, `apu_samples=443012`, `apu_dropped_samples=0`, same deterministic CPU totals.
...
- Headless action scene: 600 frames, `run_fps=72.91`, `cpu_instr=1343492`, `cpu_cycles=42379808`, `ppu_max_sprites=4`, `ppu_sprite_lines=9929`.
- Headless action scene with audio output: 600 frames, `run_fps=62.76`, `apu_samples=445592`, `apu_dropped_samples=0`, same deterministic CPU totals.
...
The current codebase was compared against the major Pan Docs hardware areas on 2026-05-24. The detailed inventory is in `docs\pandocs-inventory.md`.
